...
function CrearUnTurno({ route, navigation }) {
    ...
    useEffect(() => {
        ...
        fetch('http://192.168.0.160:1234/tpo/getEspByMed', {
            method: 'POST', // or 'PUT'
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
            },
            body: 'idMed=' + route.params.idM
    ...
    function uploadTurno() {
        ...
        fetch('http://192.168.0.160:1234/tpo/uploadTurno', {
            method: 'POST', // or 'PUT'
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
            },
            body: 'dia=' + route.params.dia + '&hora=' + moment(hora).format("HH:mm") + '&especialidad=' + selectedEsp + '&idMed=' + route.params.idM
            // {
            //     dia: route.params.dia,
            //     hora: moment(hora).format("HH:mm"),
            //     especialidad: selectedEsp,
            //     idMed: route.params.idM,
            // }
